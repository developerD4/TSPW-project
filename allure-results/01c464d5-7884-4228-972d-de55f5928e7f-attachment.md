...
- Name: API-Testing\03-validating-status-headers-and-body.spec.ts >> Read response as text
- Location: tests\API-Testing\03-validating-status-headers-and-body.spec.ts:66:5
...
```ts
  ...
  46 |   expect(body.title).toBeTruthy();
